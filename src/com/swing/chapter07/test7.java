...
import javax.swing.*;
public class test7 extends JSplitPane
{
...
class price extends JPanel 
{
	...
	price()
	{
		...
		sum1.addActionListener(new ActionListener()
		{
			...
			{
				String str1=""+(Double.parseDouble(text1.getText()))*(Double.parseDouble(text11.getText()));
				text12.setText(str1);
			}
		});
		sum2.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e) 
			{
				
				String str2=""+(Double.parseDouble(text2.getText()))*(Double.parseDouble(text21.getText()));
				text22.setText(str2);
			}
		});
				sum3.addActionListener(new ActionListener()
				{
					public void actionPerformed(ActionEvent e) 
					{
						
						String str3=""+(Double.parseDouble(text3.getText()))*(Double.parseDouble(text31.getText()));
						text32.setText(str3);
					}
				});
				sum4.addActionListener(new ActionListener()
				{
					public void actionPerformed(ActionEvent e) 
					{
						
						String str4=""+(Double.parseDouble(text3.getText()))*(Double.parseDouble(text41.getText()));
						text42.setText(str4);
					}
				});
				sum5.addActionListener(new ActionListener()
				{
					public void actionPerformed(ActionEvent e) 
					{
						
						String str5=""+(Double.parseDouble(text5.getText()))*(Double.parseDouble(text51.getText()));
						text52.setText(str5);
					}
				});
				sum6.addActionListener(new ActionListener()
				{
					public void actionPerformed(ActionEvent e) 
					{
						
						String str6=""+(Double.parseDouble(text6.getText()))*(Double.parseDouble(text61.getText()));
						text62.setText(str6);
					}
				});
				sum7.addActionListener(new ActionListener()
				{
					public void actionPerformed(ActionEvent e) 
					{
						
						String str7=""+(Double.parseDouble(text7.getText()))*(Double.parseDouble(text71.getText()));
						text72.setText(str7);
					}
				});
				sum8.addActionListener(new ActionListener()
				{
					public void actionPerformed(ActionEvent e) 
					{
						
						String str8=""+(Double.parseDouble(text8.getText()))*(Double.parseDouble(text81.getText()));
						text82.setText(str8);
					}
				});
	}
